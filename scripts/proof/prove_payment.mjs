...
const intentHash = process.env.INTENT_HASH
  ?? '0x4f2aadeb693ee37070aabe12babd6292df85b77e7ac8ceae84c0b4bd8afe77b5';

const intent = {
  intentHash,
  amount: process.env.INTENT_AMOUNT ?? '1000000',
  timestampMs: Number(process.env.INTENT_TIMESTAMP_MS ?? Date.now()),
  ...
  payeeDetails: process.env.PAYEE_HASH
    ?? '0xeb898a5fcdfa7eee51da2dcc5e389746fa2d4406c1a0478dd0bd57113ee13a44', // @test-payee
};
